 ...
 */
const HtmlCssErrorComponent = ({ htmlCode = "", cssCode = "" }) => {
  ...
  return (
    <div style={{ background: "#f8fafd", borderRadius: 8, padding: 20, margin: 16 }}>
      <h3>HTML & CSS Syntax Error Detection</h3>
      <button onClick={handleCheck} style={{ marginBottom: 16 }}>
        Check Errors
      </button>
      <div>
        <h4>HTML Errors:</h4>
...
export default HtmlCssErrorComponent;