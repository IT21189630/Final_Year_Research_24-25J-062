...
app.use('/gamified-learning/api/submission-management/challenges', challengeRoutes);
app.use('/gamified-learning/api/submission-management/submissions', submissionRoutes);
